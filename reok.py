...
# استدعاء get_event_data فقط إذا تم استيفاء الشرط
if league and htn and atn and st.session_state.confirmed:
    ...
    st.write(reshape_arabic_text("يرجى اختيار المباراة وتأكيد الاختيارات من القائمة الجانبية."))
...
if an_tp == reshape_arabic_text('شبكة التمريرات'):
    ...
    pn_time_phase = st.radio(" ", [
        reshape_arabic_text('الوقت الكامل'), 
        reshape_arabic_text('الشوط الأول'), 
        reshape_arabic_text('الشوط الثاني')
    ], index=0, key='pn_time_pill')
